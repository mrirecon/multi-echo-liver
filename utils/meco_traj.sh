...
bart traj -x $NSMP -d $FSMP -y $NSPK -m $NSLI -l -t $NMEA -r -s $GIND -D -E -e $NECO -c $TRAJ
...
bart traj -x $NSMP -d $FSMP -y $NSPK -m $NSLI -l -t $NMEA -r -s $GIND -D -E -e $NECO -c -O -V $GDC $TRAJ
